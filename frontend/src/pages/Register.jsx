  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://recipe-social-7hoa.onrender.com/api/auth/register",
      ...
      <div className="max-w-xl w-full">
        ...
        <div className="grid grid-cols-3 gap-4 mt-8 text-center">
          <div className="bg-white bg-opacity-50 rounded p-4 backdrop-blur-sm">
            ...
            <p className="text-sm text-gray-600 font-medium">Share Recipes</p>
          </div>
          <div className="bg-white bg-opacity-50 rounded p-4 backdrop-blur-sm">
            <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-2">
              <svg
            ...
            <p className="text-sm text-gray-600 font-medium">Save Favorites</p>
          </div>
          <div className="bg-white bg-opacity-50 rounded p-4 backdrop-blur-sm">
            <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-2">
              <svg
            ...
            <p className="text-sm text-gray-600 font-medium">Rate & Review</p>
          </div>
        </div>
      </div>
    </div>
